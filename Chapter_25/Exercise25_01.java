...
Description:  This program implements and tests a binary search tree.   The code was
previously provided except for the methods which I've added, which are:
height(), and breadthFirstTraversal()
 */
...
public class Exercise25_01 {
    ...
    public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
        ...
        /** Helper method to calculate the height of the tree from a given node */
        private int height(TreeNode<E> root) {
            if (root == null) {
                return 0; //An empty subtree has a height of 0
            }
            //Recursively calculate the height of the right and left subtrees
        ...
        public void breadthFirstTraversal() {
            ...
            while (!queue.isEmpty()) {
                TreeNode<E> current = queue.poll(); //Retrieve and remove the head of the list
                System.out.print(current.element + " ");  //Display current node

                if (current.left != null) {
                    queue.add(current.left); //Add the left child to the list
                }
                if (current.right != null) {
                    queue.add(current.right); //Add the right child to the list
                }
            }
