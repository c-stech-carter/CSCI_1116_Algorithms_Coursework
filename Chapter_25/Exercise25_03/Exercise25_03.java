...
It has an alternate inorder method at the bottom called nonRecursiveInorder() that uses
a stack to implement a non-recursive style method using the inorder algorithm.
 */
...
public class Exercise25_03 {
    public static void main(String[] args) {
        ...
        // Prompt the user to enter 10 integers and store them in the tree2
        ...
        //The following can be tested as well if removed from comment status,
        //I renamed the tree variable to tree2 so both can be tested in the same instance.
